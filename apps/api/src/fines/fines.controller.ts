...
export class FinesController {
    ...
    @ApiParam({ name: 'role', enum: Role, description: 'User role to update rule for' })
    @ApiBody({ schema: { example: { gracePeriod: 7, dailyRate: 2, maxFine: 50, lostBookProcessingFee: 20 } } })
