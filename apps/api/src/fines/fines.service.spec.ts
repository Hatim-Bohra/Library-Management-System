...
describe('FinesService', () => {
    ...
    describe('calculateOverdueFine', () => {
        ...
        it('should return 0 if no due date', () => {
            expect(service.calculateOverdueFine({ ...mockLoanBase, dueDate: undefined } as any)).toBe(0);
        });
        ...
        it('should return 0 if NOT overdue', () => {
            ...
            expect(service.calculateOverdueFine({ ...mockLoanBase, dueDate: futureDue })).toBe(0);
        });
        ...
        it('should return 0 if overdue but within grace period', () => {
            ...
            expect(service.calculateOverdueFine({ ...mockLoanBase, dueDate: pastDue })).toBe(0);
        });
        ...
        it('should calculate fine correctly after grace period', () => {
            ...
            expect(service.calculateOverdueFine({ ...mockLoanBase, dueDate: pastDue })).toBe(4);
        });
        ...
        it('should cap fine at max fine', () => {
            ...
            expect(service.calculateOverdueFine({ ...mockLoanBase, dueDate: pastDue })).toBe(50);
        });
    });
